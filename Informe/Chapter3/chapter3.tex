...
\section[Dise\~o general del prototipo]{Dise\~o general del prototipo}

En esta secci\'on se presenta a modo de resumen de las anteriores secciones, el dise\~o general que adopta la soluci\'on, cuando se asumen las decisiones presentadas anteriormente.

En la imagen [ref a la imagen] se puede apreciar las diferentes componentes que constituyen al proptotipo; tanto las que forman parte del router open source como las que no.
