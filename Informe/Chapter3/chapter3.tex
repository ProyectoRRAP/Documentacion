...
Es imperativo entonces la construcción de un laboratorio de pruebas, compuesto por un conjunto de nodos  lo cual a partir del hardware comercial tendría un costo significativamente mayor que a partir del hardware NetFPGA.\\
...
Como protocolo OpenFlow cuenta actualmente con cinco versiones estables. Se debe decidir entonces que versi\'on del protocolo utilizar.\\
