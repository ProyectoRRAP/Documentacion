...
El comportamiento deseado de una interfaz h\'ibrida IP/OpenFlow en el prototipo ser\'ia el que se muestra en la figura [referencia a la figura] en la parte izquierda.
