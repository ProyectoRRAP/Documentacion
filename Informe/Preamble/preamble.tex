...
\hyphenation{al-can-za-bi-li-dad}
\hyphenation{fa-ci-li-ta-ba}
\hyphenation{Networking}
\hyphenation{des-cu-bri-mien-to}
\hyphenation{des-plie-gue}
\hyphenation{fun-cio-na-li-da-des}
\hyphenation{Me-dian-te}
\hyphenation{pro-pues-ta}
\hyphenation{in-te-rac-tú-an}
\hyphenation{TOS/DHCP}
\hyphenation{RAUFlowApp}
\hyphenation{RAUFlow}
\hyphenation{al-can-za-bi-li-dad}
\hyphenation{ser-vi-cios}
\hyphenation{e-ti-que-tas}
\hyphenation{co-mu-ni-ca-ción}
\hyphenation{CAESAR}
\hyphenation{di-se-ña-da}
\hyphenation{Infrastructure}
\hyphenation{OpenFlow}
\hyphenation{benchmark}
\hyphenation{me-ca-nis-mos}
\hyphenation{ba-lan-ce-o}
\hyphenation{cons-ta-tan-do}
\hyphenation{e-va-luar}
\hyphenation{e-xis-te}
\hyphenation{ac-tua-li-za-ción} 
\hyphenation{cons-truc-ción}
\hyphenation{de-sa-rro-llar}
\hyphenation{con-si-de-ra-ble-men-te}
\hyphenation{ReferenceNIC}
\hyphenation{to-po-ló-gi-ca}
\hyphenation{ex-pe-ri-men-ta-ción}
\hyphenation{he-rra-mien-tas}
\hyphenation{es-pe-cia-li-za-dos}
\hyphenation{fa-mi-lia-ri-zán-do-se}
\hyphenation{e-sce-na-rio}
