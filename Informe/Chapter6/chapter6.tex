...
Para la construcci\'on de este escenario se instancian los siguientes servicios en el sistema (ver tabla \ref{table:TablaFlujos3}). Por cada red privada se instancian dos servicios (uno para cada sentido del tr\'afico).
...
Sobre este escenario se realizan pruebas de generar tr\'afico en una subred con destino a otra, para ambas organizaciones, probando en diferentes sentidos (primero de Subred A a Subred B y luego al reves por ejemplo), verificando adem\'as que el tr\'afico llega a la subred correcta sin importar que la numeraci\'on IP se repita (aislamiento de espacio de direccionamiento).\\
...
\begin{figure}[h!] 
\centering    
\includegraphics[width=1.0\textwidth]{Escenario2/LabE2H2H1CapturasTCPDUMP}
...
\begin{figure}[h!] 
\centering    
\includegraphics[width=1.0\textwidth]{Escenario2/LabE2H3H1Ping}
