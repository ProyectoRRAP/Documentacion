...
Tomando como ejemplo el caso del servicio S5, acorde al camino te\'orico todo tr\'afico con origen en la Subred B y destino Subred C debería ser encaminado por el enlace que conecta directamente a ambos nodos por las respectivas interfaces \textit{nf1}. 

Asumiendose como notaci\'on $(n, i)$ para referirse a un enlace, donde \textit{n} indica nodo origen e \textit{i} interfaz de reenvío en \textit{n} para el próximo salto, entonces $<(n_1, i_1), \dots, (n_k, i_k)>$ puede usarse para representar un camino. De esta forma el camino te\'orico para S5 puede expresarse de la siguiente forma:
...
Análogamente se pueden comparar los resultados para los restantes caminos.\\ 


servicio S6, seg\'un los costos de la topolog\'ia el camino deber\'ia de ser:
