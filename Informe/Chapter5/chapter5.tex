...
\begin{enumerate}
\item Clasificación de tr\'afico es la capacidad para poder distinguir entre diferentes tipos de tr\'afico en base a caracter\'isticas y patrones del mismo. En los requerimientos del prototipo no se especifica en base a que criterios o características se desea clasificar el tr\'afico, aunque de los requerimientos para la RAU2 se deduce que ser\'ia deseable poder clasificar tr\'afico por la red privada a la que pertenece, y eventualmente dentro del tr\'afico de cada VPN por aplicaci\'on. 

En la implementaci\'on de RAUFlow la clase Servicio representa tanto un servicio de VPN como una clasificaci\'on de tr\'afico particular, basando los criterios de clasificaci\'on en los campos del cabezal OpenFlow versi\'on 1.3 (matching fields).
 ...
 \myalg{\UpdateServicesLSPs(){}}{
	...
	\ForEach{ilm in ilm\_removes}{
		\ForEach{nhlfe in ilm.nhlfes}{
			remove\_node\_service\_flow(None, n, ilm, nhlfe)\\
		}
	}
