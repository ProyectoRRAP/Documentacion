...
La capa de control se compone por un lado por el controlador Ryu y un un conjunto de aplicaciones Ryu, y por otro lado los m\'odulos LSDBSync encargado de sincronizar la informaci\'on de la Link-State-Database en la instancia de Quagga ejecutada en la PC controlador con estas aplicaciones y SNMP Administrador encargado de la comunicaci\'on con los agentes SNMP instalados en cada nodo del prototipo. 
