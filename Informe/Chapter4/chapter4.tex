...
Cada nodo del prototipo responde a una entidad denominada Controlador. Esta entidad esta compuesta por varias partes(ver figura \ref{fig:OpenSourceRArch3}).
