...
Por estas razones Internet no es la red más apropiada para su utilización en el contexto académico. Es necesaria otra red diferente a Internet, que permita proveer conectividad y a su vez soportar actividades experimentales como desplegar nuevos servicios y protocolos.\\ 
...
Por \'ultimo se incluye un capitulo de ap\'endices con contenidos que por varias razones no se incluyeron en el documento, y que fueron debidamente referenciados en el desarrollo del mismo para complementar la lectura en caso de que el lector así lo desee.\\
