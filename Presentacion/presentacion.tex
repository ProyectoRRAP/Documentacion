...
%\begin{figure}[H]
%\raggedleft
%\includegraphics[width=0.95\textwidth, left]{imagenes/sdnarquitecturaprop.png}
%\end{figure}
%\end{minipage} 
%\hfill
...
%
%\pause
%\begin{textblock}{15}(0.1,-13.8)
%\begin{minipage}{\textwidth}
%\setlength{\parindent}{0pt}
%\setlength{\parskip}{0.1cm}
%\includegraphics[width=1.0\textwidth, right]{imagenes/sdnarquitecturapropc.png}
%\end{minipage}
%\end{textblock}
%\begin{textblock}{15}(-9.3,-0.8)
%\begin{minipage}{\textwidth}
%\setlength{\parindent}{0pt}
%\setlength{\parskip}{0.1cm}
%\includegraphics[width=1.0\textwidth, right]{imagenes/sdnarquitecturapropd.png}
%\end{minipage}
%\end{textblock}
%
%\end{frame}
