...
\begin{frame}
\frametitle{SDN} 
Enfoque arquitectonico alternativo al enfoque tradicional de redes.

En el enfoque tradicional tenemos que la inteligencia de la red se encuentra
distribuida en los mismos dispositivos que reenvian la informacion
...
\begin{frame}
\frametitle{SDN} 
Se habla de plano de control y plano de datos.
El plano de control donde reside la inteligencia de la red
