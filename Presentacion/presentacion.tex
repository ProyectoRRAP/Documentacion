...
\begin{itemize}
\item C\'alculo de rutas en base a IP
...
Se configuraron dos VPN L3 punto a punto conectando para dos organizaciones distintas y con la misma numeraci\'on IP en sus redes, dos sucursales f\'isicamente separadas. 
...
\item En particular los protocolos ARP, IPv4 IPv6 con tags de VLAN
\end{itemize}
