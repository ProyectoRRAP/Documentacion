...
\centering
\begin{figure}[htp]
\includegraphics[width=0.9\textwidth]{imagenes/clast.png}
\end{figure}
...
\pause
\begin{enumerate}
\item Verificar funcionalmente la implementaci\'on del prototipo
\begin{itemize}
...
\end{itemize}
\pause
\item Implementaci\'on de algunos casos de uso representativos para un prototipo de RAU2
\begin{itemize}
\item VPN L3
\item VPN L2
\end{itemize}
...
\item E2: Dos organizaciones con dos sucursales f\'isicamente separadas c/u (VPN Punto a Punto)
\end{enumerate}
